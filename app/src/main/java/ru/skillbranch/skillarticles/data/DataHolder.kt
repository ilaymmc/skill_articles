    ...
    fun findArticle(articleId: String): LiveData<ArticleData?> {
        GlobalScope.launch {
            ...
            articleData.postValue(
                ArticleData(
                    title = "Drawing a rounded corner background",
                    category = "Android",
...
data class ArticleItemData(
    ...
    val title: String = "Drawing a rounded corner background on text(end) on text Next will be long text for multiple lines on text Next will be long next line",
